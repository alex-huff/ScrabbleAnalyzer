...
public class DocumentProvider {
            ...
            for (int w = 0; w < 2; w++) {
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    for (int h = 0; h < 2; h++) {
                        ...
                        fileName += isWild ? "w" : "";
                        Document newDocument = this.getDocumentFromInputStream(this.getClass().getResourceAsStream(DocumentProvider.documentFolder + fileName + ".svg"));
    ...
    private void initWildcardDocuments() throws IOException {
        this.wildcardDocuments[0] = this.getDocumentFromInputStream(this.getClass().getResourceAsStream(DocumentProvider.documentFolder + "flatwild.svg"));
        this.wildcardDocuments[1] = this.getDocumentFromInputStream(this.getClass().getResourceAsStream(DocumentProvider.documentFolder + "isowild.svg"));
    }

    private void initBlankTileDocuments() throws IOException {
        this.blankTileDocuments[0][0] = this.getDocumentFromInputStream(this.getClass().getResourceAsStream(DocumentProvider.documentFolder + "blankdl.svg"));
        this.blankTileDocuments[0][1] = this.getDocumentFromInputStream(this.getClass().getResourceAsStream(DocumentProvider.documentFolder + "blanktl.svg"));
        this.blankTileDocuments[1][0] = this.getDocumentFromInputStream(this.getClass().getResourceAsStream(DocumentProvider.documentFolder + "blankdw.svg"));
        this.blankTileDocuments[1][1] = this.getDocumentFromInputStream(this.getClass().getResourceAsStream(DocumentProvider.documentFolder + "blanktw.svg"));
    }

    private void initDefaultBlankDocument() throws IOException {
        this.defaultBlankDocument = this.getDocumentFromInputStream(this.getClass().getResourceAsStream(DocumentProvider.documentFolder + "blank.svg"));
    }
